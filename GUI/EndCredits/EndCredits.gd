...
@onready var title_label = $SubViewportContainer/UIScalingSubViewport/MarginContainer/VBoxContainer/TitleLabel
@onready var rich_label = $SubViewportContainer/UIScalingSubViewport/MarginContainer/VBoxContainer/RichTextLabel
@onready var vbox_container = $SubViewportContainer/UIScalingSubViewport/MarginContainer/VBoxContainer
